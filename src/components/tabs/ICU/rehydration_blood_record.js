...
export class RehydrationBloodRecord extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
...
RehydrationBloodRecord.propTypes = {
    id: PropTypes.string,
...
RehydrationBloodRecord.defaultProps = {
    id: '',
    path: '',
    title: '',
    onValuesChange: () => {},
...
export default RehydrationBloodRecord;