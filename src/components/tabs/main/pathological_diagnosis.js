...
export class PathologicalDiagnosis extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
...
PathologicalDiagnosis.propTypes = {
    id: PropTypes.string,
...
PathologicalDiagnosis.defaultProps = {
    id: '',
    path: '',
    title: '',
    onValuesChange: () => {},
...
export default PathologicalDiagnosis;