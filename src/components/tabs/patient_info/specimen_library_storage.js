...
export class SpecimenLibraryStorage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
...
SpecimenLibraryStorage.propTypes = {
    id: PropTypes.string,
...
SpecimenLibraryStorage.defaultProps = {
    id: '',
    path: '',
    title: '',
    onValuesChange: () => {},
...
export default SpecimenLibraryStorage;