...
export class OperationAntibioticUsage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
...
OperationAntibioticUsage.propTypes = {
    id: PropTypes.string,
...
OperationAntibioticUsage.defaultProps = {
    id: '',
    path: '',
    title: '',
    onValuesChange: () => {},
...
export default OperationAntibioticUsage;