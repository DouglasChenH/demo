...
export class PreOperationAntibioticUsage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
...
PreOperationAntibioticUsage.propTypes = {
    id: PropTypes.string,
...
PreOperationAntibioticUsage.defaultProps = {
    id: '',
    path: '',
    title: '',
    onValuesChange: () => {},
...
export default PreOperationAntibioticUsage;