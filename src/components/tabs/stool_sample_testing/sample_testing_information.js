...
export class SampleTestingInformation extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
...
SampleTestingInformation.propTypes = {
    id: PropTypes.string,
...
SampleTestingInformation.defaultProps = {
    id: '',
    path: '',
    title: '',
    onValuesChange: () => {},
...
export default SampleTestingInformation;