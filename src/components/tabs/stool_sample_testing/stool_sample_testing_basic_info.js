...
export class StoolSampleTestingBasicInfo extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
...
StoolSampleTestingBasicInfo.propTypes = {
    id: PropTypes.string,
...
StoolSampleTestingBasicInfo.defaultProps = {
    id: '',
    path: '',
    title: '',
    onValuesChange: () => {},
...
export default StoolSampleTestingBasicInfo;